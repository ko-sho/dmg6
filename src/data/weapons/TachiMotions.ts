...
export const TACHI_MOTIONS: Motion[] = [
  ...
  { name: '兜割 (ゲージ段階：白)', motionValue: 15, elementMultiplier: 0.2, sharpnessModifier: 0, hitCount: 1, attackType: 'slash', isJump: true },
  { name: '兜割 (ゲージ段階：黄)', motionValue: 20, elementMultiplier: 0.2, sharpnessModifier: 0, hitCount: 1, attackType: 'slash', isJump: true },
  { name: '兜割 (ゲージ段階：赤)', motionValue: 23, elementMultiplier: 0.2, sharpnessModifier: 0, hitCount: 1, attackType: 'slash', isJump: true },
